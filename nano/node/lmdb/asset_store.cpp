...
void nano::lmdb::asset_store::commit_put (nano::write_transaction const & tx, nano::uint256_union const & root, nano::asset_commit_info const & info)
{
	store.release_assert_success (store.put (tx, tables::commits, root, info));
}

bool nano::lmdb::asset_store::commit_get (nano::transaction const & tx, nano::uint256_union const & root, nano::asset_commit_info & info)
{
	nano::mdb_val value;
...
void nano::lmdb::asset_store::commit_del (nano::write_transaction const & tx, nano::uint256_union const & root)
{
	store.release_assert_success (store.del (tx, tables::commits, root));
}

void nano::lmdb::asset_store::claim_put (nano::write_transaction const & tx, nano::account const & account, nano::uint256_union const & root, nano::block_hash const & hash)
{
...
bool nano::lmdb::asset_store::claim_get (nano::transaction const & tx, nano::account const & account, nano::uint256_union const & root, nano::block_hash & hash)
{
	nano::mdb_val value;
...
void nano::lmdb::asset_store::claim_del (nano::write_transaction const & tx, nano::account const & account, nano::uint256_union const & root)
{
...
nano::store_iterator<nano::asset_key, nano::block_hash> nano::lmdb::asset_store::claims_by_root_begin (nano::transaction const & tx, nano::uint256_union const & root) const
{
	return store.make_iterator<nano::asset_key, nano::block_hash> (tx, tables::claims_by_root, nano::asset_key (root, 0));
}

nano::store_iterator<nano::asset_key, nano::block_hash> nano::lmdb::asset_store::claims_by_root_end () const
{
